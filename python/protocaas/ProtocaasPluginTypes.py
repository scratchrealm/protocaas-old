...
class ProtocaasProcessingToolContext(ABC):
    @abstractmethod
...
class ProtocaasProcessingTool(ABC):
    @classmethod
    @abstractmethod
    ...
    @classmethod
    @abstractmethod
    def run(cls, context: ProtocaasProcessingToolContext):
        pass
...
class ProtocaasPluginContext(ABC):
    """The plugin context to be passed into the initialize method of the plugin
    """
    @abstractmethod
    def register_processing_tool(self, tool: ProtocaasProcessingTool):
        """Register a processing tool for the plugin

        Args:
            tool (ProtocaasProcessingTool): the processing tool to register
        """
        pass

class ProtocaasPlugin:
    @classmethod
    @abstractmethod
