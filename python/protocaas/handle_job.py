...
def handle_job(*, job_id: str):
    config_fname = '.protocaas-compute-resource-node.yaml'
    ...
    try:
        ...
        for a in job['inputFiles']:
            ...
            resp = _post_protocaas_request(req)
        ...
        # run "protocaas run-job" in the job directory
...
def _post_protocaas_request(req):
    ...
    resp = requests.post(f'{protocaas_url}/api/protocaas', json=rr)
