...
import { GetJobRequest, ProtocaasResponse } from "./types/ProtocaasRequest";
...
class JobManager {
    ...
    async initiateJob(job: ProtocaasJob): Promise<boolean> {
    ...
    // private async _initiatePythonJob(job: ProtocaasJob): Promise<boolean> {
    ...
    //     return okay
    // }
    // private async _initiateSpaJob(job: ProtocaasJob): Promise<boolean> {
...
export class RunningJob {
    ...
    private async _postProtocaasRequest(req: any): Promise<ProtocaasResponse> {
