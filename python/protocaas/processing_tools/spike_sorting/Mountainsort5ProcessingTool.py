...
from ...ProtocaasPluginTypes import ProtocaasProcessingTool, ProtocaasProcessingToolContext, InputFile, OutputFile
import pynwb
import h5py
import remfile
...
class Mountainsort5ProcessingTool(ProtocaasProcessingTool):
    @classmethod
...
def _run(context: ProtocaasProcessingToolContext):
